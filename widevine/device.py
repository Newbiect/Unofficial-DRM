...
from widevine.license_protocol_pb2 import ClientIdentification, DrmCertificate, FileHashes, SignedDrmCertificate
...
class _Structures:
    ...
    #     "client_id_len" / Int16ub,
    #     "client_id" / Bytes(this.client_id_len),
    #     #"vmp_data_len" / Int16ub,
    #     #"vmp_data" / Bytes(this.vmp_data_len)
    # )
