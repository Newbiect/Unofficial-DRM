...
from widevine.exceptions import (InvalidContext, InvalidInitData, InvalidLicenseMessage, InvalidLicenseType,
                                   InvalidSession, NoKeysLoaded, SignatureMismatch, TooManySessions)
from widevine.key import Key
from widevine.license_protocol_pb2 import (ClientIdentification, DrmCertificate, EncryptedClientIdentification,
...
from widevine.utils import get_binary_path
...
class CDM:
    ...
    common_privacy_cert = ("CAUSxwUKwQIIAxIQFwW5F8wSBIaLBjM6L3cqjBiCtIKSBSKOAjCCAQoCggEBAJntWzsyfateJO/DtiqVtZhSCtW8y"
                           ...
                           "eB6KRfRiY9FOYOgFioYHrc4E+shFexN6jWfM3rM3BdmDoh+07svUoQykdJDKR+ql1DghjduvHK3jOS8T1v+2RC/TH"
                           "hv0CwxgTRxLpMlSCkv5fuvWCSmvzu9Vu69WTi0Ods18Vcc6CCuZYSC4NZ7c4kcHCCaA1vZ8bYLErF8xNEkKdO7Dev"
                           "HMsUtadNSl/JxOI+3u4y1J30kmCPN3R2jC5MzlkR6zzL3qBLlEuSfBITEG79verJ1BORF/m7BdqEEOAYKUDvBlSub"
                           "OTOD8S/wgqYCKqvS/zRnB3PzfV0zKwo0bQQQWz53ogEMBy9szTK/NDUCXhCOmQuVGE98K/PlspEknYVeQrOnA+8XZ"
